      ...
      >
        <ScrollView showsVerticalScrollIndicator={false} className="space-y-5">
          <View className="flex-row justify-between items-start">
            <Text
              style={{ fontSize: wp(7) }}
              className="font-bold flex-1 text-neutral-300"
            >
              {item?.title}
            </Text>
            <Text
              style={{ fontSize: wp(7), color: "white" }}
          ...
          <Text
            ...
            className="text-neutral-300 tracking-wide mb-2"
          >
        ...
        <TouchableOpacity
          ...
          className="mb-6 mx-auto bg-sky-500 flex justify-center items-center rounded-full"
        >
